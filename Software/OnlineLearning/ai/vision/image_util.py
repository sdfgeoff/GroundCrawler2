...
def get_filtered_scaled(image: numpy.ndarray, resolution: tuple[int, int]) -> numpy.ndarray:
...
def get_filtered_patch(image: numpy.ndarray, resolution: tuple[int, int]) -> numpy.ndarray:
